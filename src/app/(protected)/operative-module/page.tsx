...
const initialFolders = [
  {
    ...
    files: [
      { id: 'op1-file1', name: 'Solicitud de Evento.pdf', content: 'Contenido de la solicitud del evento...', status: 'success' as const },
      { id: 'op1-file2', name: 'Plan de Seguridad.pdf', content: 'Contenido del plan de seguridad...', status: 'success' as const },
      { id: 'op1-file3', name: 'Póliza de Seguro.pdf', content: 'Contenido de la póliza...', status: 'success' as const },
    ],
  },
  {
    id: 'op2',
    ...
    files: [
      { id: 'op2-file1', name: 'Requisición de Compra.docx', content: 'Contenido de la requisición...', status: 'success' as const },
      { id: 'op2-file2', name: 'Cotización Proveedor A.pdf', content: 'Contenido de la cotización A...', status: 'success' as const },
      { id: 'op2-file3', name: 'Cotización Proveedor B.pdf', content: 'Contenido de la cotización B...', status: 'success' as const },
    ],
  },
  {
    id: 'op3',
