...
export default function LandingPage() {
  ...
  return (
    <div className="bg-home-page text-gray-800">
        ...
        <section className="text-center py-16 px-4">
          ...
          <p className="text-lg max-w-2xl mx-auto font-medium text-gray-600">{t('hero.subtitle')}</p>
           <div className="mt-8 flex flex-col sm:flex-row justify-center items-center gap-4">
              <Button onClick={handleDemoClick} size="lg" className="bg-background/90 border border-border/40 text-foreground hover:bg-background shadow-sm hover:shadow-md transition-all duration-300 rounded-full">
                {t('nav.demo')}
              </Button>
            </div>
        </section>
