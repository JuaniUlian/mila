    ...
    <div className="bg-gradient-to-br from-white via-slate-300 to-sky-900/40 text-gray-800">
      <header className="glass max-w-7xl mx-auto mt-6 px-4 py-3 flex justify-end items-center sticky top-4 z-50">
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <Button asChild className="hidden sm:inline-flex bg-slate-100 text-gray-700 font-semibold border-transparent shadow-[5px_5px_10px_#d1d5db,-5px_-5px_10px_#ffffff] hover:bg-slate-100 hover:shadow-[2px_2px_5px_#d1d5db,-2px_-2px_5px_#ffffff] active:shadow-[inset_2px_2px_5px_#d1d5db,inset_-2px_-2px_5px_#ffffff] transition-shadow duration-200 ease-in-out animate-pulse-subtle">
      ...
      <main>
        ...
        <section className="bg-slate-800 text-white text-center py-16">
          ...
          <div className="space-x-4">
            <Button asChild size="lg" className="bg-slate-800 text-slate-200 font-semibold border-transparent shadow-[5px_5px_10px_#1f2937,-5px_-5px_10px_#475569] hover:bg-slate-800 hover:shadow-[2px_2px_5px_#1f2937,-2px_-2px_5px_#475569] active:shadow-[inset_2px_2px_5px_#1f2937,inset_-2px_-2px_5px_#475569] transition-shadow duration-200 ease-in-out animate-pulse-subtle">
                <Link href="/prepare">{t('nav.demo')}</Link>
            </Button>
